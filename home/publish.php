        ...
        <div class="well col-md-12">
                ...
                <div class="col-md-8">
                    <ul class="nav nav-tabs">
                        ...
                        if($state){
                            ...
                            <li class='active'><a href='publish.php'> <span class='glyphicon glyphicon-pencil'></span>发表文章</a></li>
                            ";
                        }?>
                    </ul>
                </div>
            ...
            <div class="well col-md-12">
                ...
                if(isset($_POST['publish'])){
                    ...
                    $sql = "insert into articles(title,content,time,state,user_id,class,commentaries)
                                        values('$title','$content','$showtime','已发布','$user_id','$class','1')";
                    if($pdo->exec($sql)){
                        echo "<script>alert('发布成功!');location.href='articles.php'; </script>";
                    }else{
