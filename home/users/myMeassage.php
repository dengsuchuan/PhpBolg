        ...
        <div class="well col-md-12">
            ...
            <div class="well col-md-12">
                <ul class="nav nav-pills">
                    ...
                    <li class="active"><a href="myMeassage.php">好友留言</a></li>
                ...
                <div class="well col-md-12">
                    ...
                    $paginationArray = $pdo->friendPag('frmessage','friends_id',@$userId,10);
                    ...
                    <nav>
                        <ul class="pager">
                            <a>有<?php echo $total ?>条留言</a><br><br>
                            <a>共<?php echo $totpage ?>页</a>&nbsp;|
                            <li><a href='myMeassage.php?p=1'>首页</a></li>
                            <li><a href='myMeassage.php?p=<?php echo $prevpage ?>'>上一页</a></li>
                            <li><a href='myMeassage.php?p=<?php echo $nextpage ?>'>下一页</a></li>
                            <li><a href='myMeassage.php?p=<?php echo $totpage ?>'>尾部</a></li>
                    ...
                    <?php foreach ($messageArray as $value){?>
                        <div class="well">
                            ...
                            <a href="mod/delFriendMeassage.php?id=<?php echo $value['id']; ?>" style="font-size:13px;padding-top:2px;"> <span class="glyphicon glyphicon-trash"></span>删除</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                            <p>
