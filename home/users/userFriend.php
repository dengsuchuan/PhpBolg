        ...
        <div class="well col-md-12">
            ...
            <div class="well col-md-12">
                <ul class="nav nav-pills">
                    ...
                    <li class="active"><a href="userFriend.php">好友列表</a></li>
                ...
                <div class="well col-md-7">
                    <?php
                    $paginationArray = $pdo->friendPag('friends','user_id',@$id,15);
                    ...
                    ?>
                    <legend><span class="glyphicon glyphicon-user"></span>我的好友&nbsp;|&nbsp;<a>共有<?php echo $total ?>位</a></legend>
                    <!----------------------下面是你的好友-------------------->
                    <table class="table table-hover table-bordered text-center">
                        <thead>
                        <tr class="active">
                            <th class="text-center">好友昵称</th>
                            <th class="text-center">操作</th>
                        </tr>
                        </thead>
                        <?php
                        $sql = "select f.id,f.user_id,f.friends_id,u.username,s.username as frusername
                            from friends f inner join users u on f.user_id = u.id inner join users s on f.friends_id = s.id
                            where f.user_id = '$id' limit $offset,$length;";
                        $userFriendArray = $pdo->select($sql);
                        ?>
                        <nav>
                            <ul class="pager">
                                <li><a href='userFriend.php?friendPagP=1'>首页</a></li>
                                <li><a href='userFriend.php?friendPagP=<?php echo $prevpage ?>'>上一页</a></li>
                                <li><a href='userFriend.php?friendPagP=<?php echo $nextpage ?>'>下一页</a></li>
                                <li><a href='userFriend.php?friendPagP=<?php echo $totpage ?>'>尾部</a></li>
                            </ul>
                        </nav>
                        <?php
                        foreach($userFriendArray as $value){
                            echo "<tbody><tr class='info'>";
                            echo "<td>".$value['frusername']."</td>";      //多表查询 查用户名
                            echo "
                                    <form method='post' about='articles.php'>
                                        <td class='text-center'>
                                            <div class='btn-group'>
                                                <a href='mod/delFriend.php?fid=".$value['id']."'>解除关系</a>
                                                <a href='mod/friendMessage.php?user_id=".$value['user_id']."&fuid=".$value['friends_id']."&username=".$value['frusername']."'>给TA留言</a>
                                            </div>
                                        </td>
                                    </form>
                                    </tr>
                ...
                <div class="well col-md-5">
                    <div class="well col-md-12">
                        <legend><span class="glyphicon glyphicon-list-alt"></span>查找用户</legend>
                        ...
                        <table class="table table-hover table-bordered text-center">
                            ...
                            if(isset($_POST['go'])){
                                ...
                                $allLimitArray = $pdo->conn()->query($sqlCountLimit)->fetchAll(PDO::FETCH_ASSOC);
                                foreach($allLimitArray as $value){
                                    ...
                                    echo "
                                        <form method='post' about='articles.php'>
                                            <td class='text-center'>
                                                <div class='btn-group'>
                                                    <a href='mod/addFriend.php?uid=".$id."&fruid=".$value['id']."'>添加</a>
                                                </div>
                                            </td>
                                        </form>
                                        </tr>
                    ...
                    <div class="well col-md-12">
                        ...
                        <table class="table table-hover table-bordered text-center">
                            ...
                            //$sqlCountLimit = "select * from articles limit $offset,$length";  //查询指定条数
                            ...
                            <nav>
                                <ul class="pager">
                                    <li><a href='userFriend.php?p=1'>首页</a></li>
                                    <li><a href='userFriend.php?p=<?php echo $prevpage ?>'>上一页</a></li>
                                    <li><a href='userFriend.php?p=<?php echo $nextpage ?>'>下一页</a></li>
                                    <li><a href='userFriend.php?p=<?php echo $totpage ?>'>尾部</a></li>
                                </ul>
                            </nav>
                            <?php
                            foreach($allLimitArray as $value){
