                    ...
                    if($createDatabaseQuery = mysqli_query($conn,$sqlCreateDatabase)){
                        ...
                        $config = "
                         CREATE TABLE config (
                          ...
                          frontRecord varchar(100) DEFAULT NULL,
                          PRIMARY KEY (`id`)
                        );
                        ";
                        ...
                        mysqli_query($conn,"
                            INSERT INTO tools VALUES 
                                ('1', 'H5游戏', '搭建至Geekln域名下的小游戏', 'games.png', 'http://games.geekln.cn'),
                                ('2', 'Jetbrains', '可激活Jetbrains全系列', 'Jetbrains.jpg', 'http://idea.liyang.io/'),
                                ('3', '编码在线转换器', '在线转换各种编码', 'code.jpg', 'http://tool.oschina.net/encode'),
                                ('4', '文字加密解密', 'url,base64,md5加密解密', 'jmjm.png', 'https://tool.lu/encdec/'),
                                ('5', '进制转换', '常用进制转换工具', 'jzzh.png', 'https://tool.lu/hexconvert/'),
                                ('6', 'IP地址查询', '查询指定IP地址信息', 'ip.jpg', 'https://tool.lu/ip/');
                        ");//默认的工具表
